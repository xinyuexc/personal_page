...
export const timeline = [
  {
    ...
    period: '7 years',
    description:
      'Worked across agencies including Kantar and MetrixLab / Toluna, building quantitative studies and client-facing research stories.',
  },
  {
    label: 'Data Science Master’s',
    period: 'Recent transition',
    description:
      'Added a stronger technical foundation in analytics, modeling, and reproducible workflows.',
  },
  {
    label: 'Portfolio Build',
    period: 'Current focus',
    description:
      'Building a few honest portfolio projects and articles that show how research and data science can work together.',
  },
];
...
export const workingStyle = [
  'Research-first thinking with an increasing technical toolkit.',
  'A preference for clear questions, simple methods, and honest scope.',
  'Strong interest in roles where analysis and communication matter equally.',
];
